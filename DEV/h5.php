...
<a class="ui-btn ui-corner-all ui-shadow ui-btn-inline" data-rel="popup" data-transition="pop" href="#popupBasic">
Basic Popup</a>
<div id="popupBasic" data-role="popup">
	<p>This is a completely basic popup, no options set.</p>
</div>
<a class="ui-btn ui-corner-all ui-shadow ui-btn-inline" data-position-to="window" data-rel="popup" href="#popupPhotoLandscape">
Photo landscape</a>
<div id="popupPhotoLandscape" class="photopopup" data-corners="false" data-overlay-theme="a" data-role="popup" data-tolerance="30,15">
	<a class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right" data-rel="back" href="#">
	Close</a><img alt="Photo landscape" src="http://200.200.200.212/example/qrcode.php?data=<?php echo urlencode($urlPid001);?>">
</div>
